"""
Django settings for cesfamProyecto project.
...
# Se puede controlar con la variable de entorno DJANGO_DEBUG=False
...
ROOT_URLCONF = 'cesfamProyecto.urls'
...
WSGI_APPLICATION = 'cesfamProyecto.wsgi.application'
